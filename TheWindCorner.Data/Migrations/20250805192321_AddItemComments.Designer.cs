...
namespace TheWindCorner.Web.Data.Migrations
{
    ...
    [Migration("20250805192321_AddItemComments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheWindCorner.Data.Models.Entities.ItemComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasComment("ItemComment Identifier");

                    b.Property<DateTime>("CommentedOn")
                        .HasColumnType("datetime2")
                        .HasComment("The date and time of the comment");
            ...
            modelBuilder.Entity("TheWindCorner.Data.Models.Entities.ItemComment", b =>
                {
                    b.HasOne("TheWindCorner.Data.Models.Entities.Item", "CommentedItem")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TheWindCorner.Data.Models.User.ApplicationUser", "CommentOwner")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
